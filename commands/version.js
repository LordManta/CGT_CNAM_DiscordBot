const Evt_cmd= SC.evt("Evt_Command_version");
...
CommandManager.prototype.action= function(engine){
    ...
    if(data){
    for(var args of data){
      const msg= args.m;
      msg.reply(`\`\`\`CGT BOT Version ${this.client.version} (build:${this.client.buildNumber})\nbased on SugarCubes.js version ${SC.sc_version}\`\`\``);
      }
    }
  };
...
module.exports= {
  cmd: "version"
, evt: Evt_cmd
, help: ": affiche le numéro de version du bot"
, beh: function(tgt){
